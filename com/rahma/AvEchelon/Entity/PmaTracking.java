...
public class PmaTracking implements java.io.Serializable {
	...
	public PmaTracking(PmaTrackingId id, Date dateCreated, Date dateUpdated, String schemaSnapshot,
			int trackingActive) {
		this.id = id;
	...
	public PmaTracking(PmaTrackingId id, Date dateCreated, Date dateUpdated, String schemaSnapshot, String schemaSql,
			String dataSql, String tracking, int trackingActive) {
		this.id = id;
		this.dateCreated = dateCreated;
		this.dateUpdated = dateUpdated;
		this.schemaSnapshot = schemaSnapshot;

...
@Service
public class ExcelMensuelService {

    @Autowired private ServiceHistorique service;
    @Autowired private ServiceAvancement serviceAvancement;

    public ResponseEntity<ByteArrayResource> generateExcelMensuel(String dateEffet) throws IOException, ParseException {
        List<HistoriqueAv> avancements = service.recupereLesHistoriquePersonnelsMensuel(dateEffet); 
	    avancements.sort(Comparator.comparingInt(av -> Integer.parseInt(av.getMle())));
	    /********************************************************************************/
	    XSSFWorkbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("etat Mensuel_" + dateEffet);
        ...
        cell10.setCellValue("PERSONNEL : MENSUEL");

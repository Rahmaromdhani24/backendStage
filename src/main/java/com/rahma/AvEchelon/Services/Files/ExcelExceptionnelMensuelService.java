...
@Service
public class ExcelExceptionnelMensuelService {
    ...
    public ResponseEntity<ByteArrayResource> generateExcelMensuel57ans(String dateEffet) throws IOException, ParseException {
        ...
        Sheet sheet = workbook.createSheet("etat ExceptionnelMensuel_" + dateEffet);
